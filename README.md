- [logcli export scripts](#logcli-export-scripts)
  - [สิ่งที่ต้องติดตั้งบน Ubuntu](#สิ่งที่ต้องติดตั้งบน-ubuntu)
  - [ตั้งค่า query พื้นฐาน](#ตั้งค่า-query-พื้นฐาน)
  - [ตั้งค่ารหัสผ่านสำหรับไฟล์ `.7z`](#ตั้งค่ารหัสผ่านสำหรับไฟล์-7z)
  - [รูปแบบเวลา](#รูปแบบเวลา)
  - [1. ส่งออก log ตามช่วงเวลาเป็นไฟล์ `.log` ปกติ](#1-ส่งออก-log-ตามช่วงเวลาเป็นไฟล์-log-ปกติ)
  - [2. ส่งออก log ตามช่วงเวลาเป็นไฟล์ `.log` ปกติ พร้อมกำหนด query เพิ่ม](#2-ส่งออก-log-ตามช่วงเวลาเป็นไฟล์-log-ปกติ-พร้อมกำหนด-query-เพิ่ม)
  - [3. ส่งออก log ตามช่วงเวลาแบบบีบอัดและเข้ารหัส](#3-ส่งออก-log-ตามช่วงเวลาแบบบีบอัดและเข้ารหัส)
  - [4. ส่งออก log ตามช่วงเวลาแบบบีบอัดและเข้ารหัส พร้อมกำหนด query เพิ่ม](#4-ส่งออก-log-ตามช่วงเวลาแบบบีบอัดและเข้ารหัส-พร้อมกำหนด-query-เพิ่ม)
  - [วิธีแตกไฟล์ archive](#วิธีแตกไฟล์-archive)
